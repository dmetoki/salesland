...
export default function TimeEvolutionMultiple() {
    ...
    return (
        <Card>
            ...
            <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
                ...
                >
                    <AreaChart data={filteredData} margin={{right: 10}}>
                        <defs>
                        ...
                        <YAxis
                            ...
                            tickFormatter={(value) => (value === 0 ? "" : value)} // 👈 skip 0
                        />
                        <ChartTooltip
                        ...
                        <Area
                            ...
                            stackId="a"
                        />
                        <ChartLegend content={<ChartLegendContent payload={undefined} />} className="mt-4" />
                    </AreaChart>
                </ChartContainer>
            </CardContent>
        </Card>
